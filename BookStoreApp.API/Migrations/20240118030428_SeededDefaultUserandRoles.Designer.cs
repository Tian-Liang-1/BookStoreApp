...
namespace BookStoreApp.API.Migrations
{
    ...
    [Migration("20240118030428_SeededDefaultUserandRoles")]
            ...
            modelBuilder.Entity("BookStoreApp.API.Data.ApiUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d0e2bfd1-05f7-487c-83ad-68f9b135cd87",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEFVJipiWX95HQ8pItXIen8dkakpLxjIiXJXyBmzxFnUe+fYGONpYTO0cj4Ko47l/cA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d107fb96-2f81-4bea-9468-77d8d9c12ef9",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9130a058-764d-4de7-9f79-5399b092b418",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAELoD+kY+DV0MT4PX433jT0D/FJSAz1n8HOwnErkPm6tP1m6ZbebqCIGwWcPmsvksHA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "834c4608-9ba3-40ae-91ce-01d7875d0355",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("BookStoreApp.API.Data.Author", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Authors__3214EC0781AE846B");
            ...
            modelBuilder.Entity("BookStoreApp.API.Data.Book", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Books__3214EC07F50BCBB5");

                    b.HasIndex("AuthorId");

                    b.HasIndex(new[] { "Isbn" }, "UQ__Books__447D36EABC9BD4C8")
                        .IsUnique();
